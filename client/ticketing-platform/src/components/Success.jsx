...
export default function Success({setActive}){
    ...
    return (
        <motion.div 
            ...
            <FontAwesomeIcon className=" h-32    text-complementary" icon={faCircleCheck} beatFade></FontAwesomeIcon>
            <h1 className="font-bold text-2xl text-center">Successful Checkout</h1>
            <h3 className=" text-lg text-center">Thank you. A confirmation message has been sent to your email.  </h3>
