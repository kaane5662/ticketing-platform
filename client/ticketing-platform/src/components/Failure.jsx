...
export default function Failure({setActive}){
    ...
    return (
        <motion.div 
            ...
            <FontAwesomeIcon className=" h-32    text-complementary" icon={faCircleXmark} beatFade></FontAwesomeIcon>
            <h1 className="font-bold text-2xl text-center">Payment Unsucessful</h1>
            <h3 className=" text-lg text-center">Sorry. Your payment was not processed successfully.</h3>
