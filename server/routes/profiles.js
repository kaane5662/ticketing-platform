...
router.post("/", async (req,res)=>{
    ...
    try{
        ...
        // console.log(token)
        res.cookie("token", token, { maxAge: 900000, domain: ".swftt.vip" ,secure: process.env.NODE_ENV === "production", httpOnly:true, path:"/", sameSite: 'Lax' })
...
router.put("/", async (req,res)=>{
    ...
    try{
        ...
        res.cookie("token", token, { maxAge: 900000,secure: process.env.NODE_ENV === "production", httpOnly: true, path: "/", domain:".swftt.vip", sameSite: 'Lax'  })
